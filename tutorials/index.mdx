...
<Card>
  <div className="space-y-2">
    <div>✅ A Pixel Patrol account (sign up at [pixelpatrol.app](https://pixelpatrol.app))</div>
...
3. **Contact Support**: Email us at [support@pixelpatrol.app](mailto:support@pixelpatrol.app)
