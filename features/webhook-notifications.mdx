...
|-------|-------------|---------|
| `media.submitted` | New media received | Media details, metadata |
| `media.moderated` | Moderation complete | Status, AI results, rules |
| `media.updated` | Status changed | Previous/new status |
| `media.remoderated` | Re-analysis complete | New results |

### System Events

| Event | Description | Payload |
|-------|-------------|---------|
| `rule.created` | New rule added | Rule configuration |
| `rule.updated` | Rule modified | Changes |
| `webhook.test` | Test webhook | Test data |
| `subscription.updated` | Plan changed | Subscription details |
