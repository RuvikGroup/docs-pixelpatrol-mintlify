...
const team = await createTeam({
  ...
  description: 'Main moderation team for ACME Corp',
  settings: {
    defaultModerationLevel: 'balanced',
...
1. **Team Profile**: Name and description
2. **First Site**: Create initial site
3. **Invite Members**: Build your team
4. **Configure Rules**: Set moderation policies
